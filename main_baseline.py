...
if __name__ == "__main__":
    """
    Run this file to test your data on our baseline classifier.
    """
    ...
    # loop over all images in the images_path and compute the ABC features
    i = 1
    ...
    # Using the newly computed ABC features and label, test the model on our baseline classifier
